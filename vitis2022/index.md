# Vitis2022 (Vivado2022) のインストール方法
...
インストールが完了すると、デスクトップにVivadoのアイコンが生成されます。

26  
![ ](026.png)

黄色のVivadoのアイコンをクリックして起動し、以下のソフトが立ち上がれば、インストール成功です。
...
次に `C:\Xilinx\Vivado\2022.1\data\boards\board_files` のフォルダを開きます。
